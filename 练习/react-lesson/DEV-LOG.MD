...
如果你的组件叫Card 那么你新建一个 Card.module.css的文件就可以了。如果叫其他名称会报错;注意：必须是xx.module.css啥的
中间的module不能少
...
const ConfirmModal = (props: ConfirmModalProps) => {
    return (
        <div>
            ...
            //这里要注意 使用html自带的onlick函数 自定义是触发不了的
...
Maintain -Vendor - VendorList.jsx 这样不会报错
Maintain -Vendor - VendorList.jsx 这样会报错
...
这样声明，编辑器不会提示name和age是必填的；不太好，还不如不用

```typescript jsx
export const MockListItem: React.FC = (props: Item) => {
